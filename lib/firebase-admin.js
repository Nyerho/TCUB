...
const DEFAULT_FIREBASE_PROJECT_ID = 'tcub-b96a6';
const DEFAULT_FIREBASE_ADMIN_UID = 'rGgEI67ClbM7dfI6GsGMaAC2cpn2';
...
async function syncLocalUserToFirebaseAuth(user, plainPassword) {
  ...
  const desiredUid = Number(user.is_admin) === 1 && (process.env.FIREBASE_ADMIN_UID || DEFAULT_FIREBASE_ADMIN_UID)
    ? (process.env.FIREBASE_ADMIN_UID || DEFAULT_FIREBASE_ADMIN_UID)
    : `tcub-${user.id}`;
