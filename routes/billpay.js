...
router.get('/', requireAuth, requireVerified, (req, res) => {
  ...
  res.render('billpay/index', {
    title: 'Bill Payments - Think Union Credit Bank',
    page: 'billpay',
    payments,
    upcoming,
    completed,
...
router.get('/pay', requireAuth, requireVerified, (req, res) => {
  ...
  res.render('billpay/pay', {
    title: 'Pay Bill - Think Union Credit Bank',
    page: 'billpay',
    accounts,
    billers: BILLERS,
    selectedBiller
...
router.get('/scheduled', requireAuth, (req, res) => {
  ...
  res.render('billpay/scheduled', {
    title: 'Scheduled Payments - Think Union Credit Bank',
    page: 'billpay',
    scheduled
  });
});
...
router.get('/:id', requireAuth, (req, res) => {
  ...
  res.render('billpay/detail', {
    title: 'Bill Payment Details - Think Union Credit Bank',
    page: 'billpay',
    payment,
    bill: payment
  });
...
router.get('/deposit/new', requireAuth, requireVerified, (req, res) => {
  ...
  res.render('billpay/deposit', {
    title: 'Deposit Funds - Think Union Credit Bank',
    page: 'billpay',
    accounts
  });
});
...
router.get('/withdraw/new', requireAuth, requireVerified, (req, res) => {
  ...
  res.render('billpay/withdraw', {
    title: 'Withdraw Funds - Think Union Credit Bank',
    page: 'billpay',
    accounts
  });
});
