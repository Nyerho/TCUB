...
router.get('/', requireAuth, requireVerified, (req, res) => {
  ...
  res.render('transfers/index', {
    title: 'Transfers - Think Union Credit Bank',
    page: 'transfers',
    accounts,
    beneficiaries,
    recent
...
router.get('/local', requireAuth, requireVerified, (req, res) => {
  ...
  res.render('transfers/local', {
    title: 'Local Transfer - Think Union Credit Bank',
    page: 'transfers',
    accounts,
    beneficiaries,
    selectedAccountId,
...
router.get('/international', requireAuth, requireVerified, (req, res) => {
  ...
  res.render('transfers/international', {
    title: 'International Transfer - Think Union Credit Bank',
    page: 'transfers',
    accounts,
    selectedAccountId,
    hasTransferPin: Boolean(transferUser && transferUser.transfer_pin_hash),
...
router.get('/history', requireAuth, (req, res) => {
  ...
  res.render('transfers/history', {
    title: 'Transfer History - Think Union Credit Bank',
    page: 'transfers',
    transactions,
    filters: req.query
  });
...
router.get('/:id', requireAuth, (req, res) => {
  ...
  res.render('transfers/detail', {
    title: 'Transaction Details - Think Union Credit Bank',
    page: 'transfers',
    transaction
  });
});
