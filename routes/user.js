...
router.get('/dashboard', requireAuth, (req, res) => {
  ...
  res.render('user/dashboard', {
    title: 'Dashboard - Think Union Credit Bank',
    page: 'dashboard',
    user,
    accounts,
    transactions,
...
router.get('/profile', requireAuth, (req, res) => {
  ...
  res.render('user/profile', {
    title: 'My Profile - Think Union Credit Bank',
    page: 'profile',
    user
  });
});
...
router.get('/settings', requireAuth, (req, res) => {
  ...
  res.render('user/settings', {
    title: 'Settings - Think Union Credit Bank',
    page: 'settings',
    user,
...
router.get('/statements', requireAuth, (req, res) => {
  ...
  res.render('user/statements', {
    title: 'Account Statements - Think Union Credit Bank',
    page: 'statements',
    accounts,
    selectedAccount,
    transactions,
...
router.get('/beneficiaries', requireAuth, (req, res) => {
  ...
  res.render('user/beneficiaries', {
    title: 'Beneficiaries - Think Union Credit Bank',
    page: 'beneficiaries',
    beneficiaries
  });
});
...
router.get('/notifications', requireAuth, (req, res) => {
  ...
  res.render('user/notifications', {
    title: 'Notifications - Think Union Credit Bank',
    page: 'notifications',
    notifications
  });
});
...
router.get('/support', requireAuth, (req, res) => {
  res.render('user/support', {
    title: 'Support - Think Union Credit Bank',
    page: 'support'
  });
});
