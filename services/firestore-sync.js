...
function toFirestoreAccount(account) {
  return {
    ...
    branch: account.branch || 'Atlanta CBD',
    bsb: account.bsb || '021000021',
...
function toFirestoreTransaction(txn) {
  return {
    ...
    iban: txn.iban || '',
    country: txn.country || 'United States',
...
function upsertLocalUser(userDoc, explicitId) {
  ...
  const payload = {
    ...
    country: userDoc.country || 'United States',
...
function upsertLocalAccount(accountDoc, explicitId) {
  ...
  const payload = {
    ...
    branch: accountDoc.branch || 'Atlanta CBD',
    bsb: accountDoc.bsb || '021000021',
...
function upsertLocalTransaction(txnDoc, explicitId) {
  ...
  const payload = {
    ...
    iban: txnDoc.iban || '',
    country: txnDoc.country || 'United States',
