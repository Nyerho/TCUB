...
const uploadDir = isServerlessRuntime
  ? path.join(os.tmpdir(), 'thinkunioncreditbank', 'uploads', 'kyc')
...
router.get('/', requireAuth, (req, res) => {
  ...
  res.render('kyc/index', {
    title: 'Identity Verification (KYC) - Think Union Credit Bank',
    page: 'kyc',
    kycRecords,
    records: kycRecords,
    latest,
...
router.get('/submit', requireAuth, (req, res) => {
  ...
  res.render('kyc/submit', {
    title: 'Submit KYC - Think Union Credit Bank',
    page: 'kyc',
    user,
    documentTypes: DOCUMENT_TYPES
  });
...
router.get('/:id', requireAuth, (req, res) => {
  ...
  res.render('kyc/detail', {
    title: 'KYC Details - Think Union Credit Bank',
    page: 'kyc',
    kyc
  });
});
