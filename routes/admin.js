...
router.get('/dashboard', requireAdmin, async (req, res) => {
  ...
  res.render('admin/dashboard', {
    title: 'Admin Dashboard - Think Union Credit Bank',
...
router.get('/users', requireAdmin, async (req, res) => {
  ...
  res.render('admin/users', {
    title: 'User Management - Think Union Credit Bank',
    page: 'admin-users',
    users,
    userAccounts,
    filters: req.query
...
router.get('/users/create', requireAdmin, (req, res) => {
  res.render('admin/user-create', {
    title: 'Create User - Think Union Credit Bank',
    page: 'admin-users'
  });
});
...
router.post('/users/create', requireAdmin, async (req, res) => {
  ...
  addNotification(userId, 'Account Created', 'Your Think Union Credit Bank account has been created by an administrator.', 'success');
...
router.get('/users/:id', requireAdmin, async (req, res) => {
  ...
  res.render('admin/user-detail', {
    title: `User: ${user.first_name} ${user.last_name} - Think Union Credit Bank`,
    page: 'admin-users',
    user,
    customer: user,
    accounts,
...
router.get('/approvals', requireAdmin, (req, res) => {
  ...
  res.render('admin/approvals', {
    title: 'Approvals - Think Union Credit Bank',
...
router.get('/accounts', requireAdmin, (req, res) => {
  ...
  res.render('admin/accounts', {
    title: 'Account Management - Think Union Credit Bank',
    page: 'admin-accounts',
    accounts,
    filters: req.query
  });
...
router.get('/accounts/:id', requireAdmin, (req, res) => {
  ...
  res.render('admin/account-detail', {
    title: `Account ${account.account_number} - Think Union Credit Bank`,
    page: 'admin-accounts',
    account,
    transactions
  });
...
router.get('/cards', requireAdmin, (req, res) => {
  ...
  res.render('admin/cards', {
    title: 'Card Management - Think Union Credit Bank',
    page: 'admin-cards',
    cards
  });
});
...
router.get('/loans', requireAdmin, (req, res) => {
  ...
  res.render('admin/loans', {
    title: 'Loan Management - Think Union Credit Bank',
    page: 'admin-loans',
    loans
  });
});
...
router.get('/transactions/new', requireAdmin, (req, res) => {
  ...
  res.render('admin/transaction-form', {
    title: 'Create Transaction - Think Union Credit Bank',
...
router.get('/transactions', requireAdmin, async (req, res) => {
  ...
  res.render('admin/transactions', {
    title: 'All Transactions - Think Union Credit Bank',
    page: 'admin-transactions',
    transactions,
    accounts,
    filters: req.query,
...
router.get('/transactions/:id', requireAdmin, (req, res) => {
  ...
  res.render('admin/transaction-form', {
    title: `Transaction #${transaction.id} - Think Union Credit Bank`,
    page: 'admin-transactions',
    transaction,
    accounts,
    filters: {}
...
router.get('/audit-logs', requireAdmin, (req, res) => {
  ...
  res.render('admin/audit-logs', {
    title: 'Audit Logs - Think Union Credit Bank',
    page: 'admin-audit',
    logs,
    auditLogs: logs
  });
...
router.get('/reports', requireAdmin, (req, res) => {
  ...
  res.render('admin/reports', {
    title: 'Reports & Analytics - Think Union Credit Bank',
    page: 'admin-reports',
    revenue,
    monthlyData,
    typeBreakdown,
...
router.get('/settings', requireAdmin, (req, res) => {
  ...
  res.render('admin/settings', {
    title: 'Admin Settings - Think Union Credit Bank',
    page: 'admin-settings',
    admins
  });
});
