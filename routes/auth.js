...
router.post('/register', [
  ...
  const entryTag = `[TCUB-REGISTER-ENTRY][${Date.now()}]`;
...
router.get('/login', (req, res) => {
  ...
  res.render('auth/login', {
    title: 'Login - Think Union Credit Bank',
    page: 'login'
  });
});
...
router.get('/forgot-password', (req, res) => {
  res.render('auth/forgot', {
    title: 'Forgot Password - Think Union Credit Bank',
    page: 'forgot'
  });
});
...
router.get('/reset-password', (req, res) => {
  ...
  res.render('auth/reset', {
    title: 'Reset Password - Think Union Credit Bank',
    page: 'reset-password',
    token
  });
});
